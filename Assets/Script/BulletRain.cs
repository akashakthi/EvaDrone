...
public class BulletRain : MonoBehaviour
{
    ...
    IEnumerator SpawnObjects()
    {
        while (true)
        {
            ...
            GameObject spawnedObject = Instantiate(objectPrefab, new Vector3(10.57f, -3f, 0), Quaternion.identity);
            ...
            // Tambahkan script DestroyOnPlayersTrigger ke object yang baru di-instantiate
            var destroyOnPlayerTrigger = spawnedObject.AddComponent<DestroyOnPlayersTrigger>();
            destroyOnPlayerTrigger.airStrikeAudioSource = audioSource; // Kirim AudioSource ke DestroyOnPlayersTrigger
            destroyOnPlayerTrigger.effectDestroy = effectDestroy; // Kirim effectDestroy ke DestroyOnPlayersTrigger
...
public class DestroyOnPlayersTrigger : MonoBehaviour
{
